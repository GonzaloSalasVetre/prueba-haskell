...
/* package prueba-haskell-0.1.0.0 */
#ifndef VERSION_prueba_haskell
#define VERSION_prueba_haskell "0.1.0.0"
#endif /* VERSION_prueba_haskell */
#ifndef MIN_VERSION_prueba_haskell
#define MIN_VERSION_prueba_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_prueba_haskell */
...
#define CURRENT_COMPONENT_ID "prueba-haskell-0.1.0.0-inplace-prueba-haskell"
